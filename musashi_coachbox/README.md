...
#### インストール方法  
以下のコマンドで必要なパッケージをインストールするだけ． QtCreatorにQtDesignerが含まれているだけなので，QtCreatorは使わなくていい．  
...
開発自体はQtデザイナで開いて行います．XML言語を勉強する必要はありません．
...
カスタムWidgetクラスが定義されたモジュールをimportしており，
Pluginとして起動する機能を所有しています．
